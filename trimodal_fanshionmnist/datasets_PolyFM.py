...
class PolyFMDataset(Dataset):
    ...
    def _create_polymnist_dataset(savepath, backgroundimagepath,
        ...
        # load MNIST data
        mnist = datasets.MNIST("../data", train=train, download=False,
                               transform=None)
        ...
        for digit in range(10):
            ...
            for m in range(num_modalities):
                ...
                for i, ix in enumerate(ixs_perm):
                    ...
                    new_img = PolyFMDataset._add_background_image(
...
if __name__ == "__main__":
    ...
    # create dataset
    PolyFMDataset._create_polymnist_dataset(args.savepath_train,
        args.backgroundimagepath, args.num_modalities, train=True)
    PolyFMDataset._create_polymnist_dataset(args.savepath_test,
